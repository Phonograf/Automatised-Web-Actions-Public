...
wss.on('connection', function connection(ws) {
    ...
    ws.on('message', function message(data) {
        ...
        if (data.action == "greetings") {
            ...
            if (data.password != procces.env.BACKEND_WS_PASSWORD) {
...
router.post("/websocket/echo/:id", auth, Permissions(["ManageClients"]), (req, res, next) => {
...
class computer {
    ...
    message(data) {
        ...
        */
        ...
        switch (data.action) {
            case "message":
                this._log.push(JSON.parse(data));
                break;
